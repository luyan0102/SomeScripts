...
echo 'export NEWS_KEYWORDS="BTC,Bitcoin,ETH,Ethereum,cryptocurrency,blockchain,Fed,interest rate,inflation,CPI,halving,ETF,stablecoin,DeFi,Layer2,regulation,mining,exchange,altcoin,bull,bear,correction,surge,crash,open interest,liquidation,Solana,Layer 2,SEC"' >> ~/.bashrc
